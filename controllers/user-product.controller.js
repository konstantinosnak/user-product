...
exports.findAll = async(req, res) => {
    ...
    try {
        ...
        console.log("Success in bringing all the user's products")
    } catch (err) {
...
exports.findOne = async(req, res) => {
    ...
    console.log("Find user's with username products ", username);
...
exports.updateProduct = async(req, res) => {
    ...
    try {
        ...
        res.status(400).json({ status: false, data: err});
        console.log("Problem in updating product for user ")
    }
}
...
exports.deleteProduct = async(req, res) => {
    ...
    try {
        ...
        res.status(400).json({ status: false, data: err});
        console.log("Problem in deleting product for user ")  
    }
}
